    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/productReviews/**").hasAnyAuthority("ROLE_CUSTOMER", "ROLE_ADMIN", "ROLE_OWNER")
                        .requestMatchers(HttpMethod.PATCH, "/productReviews/**").hasAnyAuthority("ROLE_CUSTOMER", "ROLE_ADMIN", "ROLE_OWNER")
                        .requestMatchers(HttpMethod.DELETE, "/productReviews/**").hasAnyAuthority("ROLE_CUSTOMER", "ROLE_ADMIN", "ROLE_OWNER")
                        .requestMatchers("/payments/pay/").hasAnyAuthority("ROLE_CUSTOMER", "ROLE_ADMIN")
                        .requestMatchers("/orders/**").hasAnyAuthority("ROLE_CUSTOMER", "ROLE_OWNER", "ROLE_ADMIN")
                        .requestMatchers("/address/**").hasAnyAuthority("ROLE_CUSTOMER", "ROLE_OWNER", "ROLE_ADMIN")
                        .requestMatchers("/favorites/**").hasAnyAuthority("ROLE_CUSTOMER", "ROLE_ADMIN", "ROLE_OWNER")
